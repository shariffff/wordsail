...
Prepares the server with base packages and the WordSail system user.

## What It Does

- Creates the `wordsail` system user for administration
...
```yaml
wordsail_ssh_key: "~/.ssh/wordsail.pub"  # or paste key directly
```
